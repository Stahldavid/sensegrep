...
- [#46](https://github.com/Stahldavid/sensegrep/pull/46) [`ab3cfb5`](https://github.com/Stahldavid/sensegrep/commit/ab3cfb5dfb7295f8e05666e407cb5d4b72aaced0) Thanks [@Stahldavid](https://github.com/Stahldavid)! - Improve Jev search with query-sensitive scoring, helper-reserved candidate pools up to 80, per-aspect evidence coverage, bounded helper recovery, and source-free diagnostic traces. Preserve local fallback and separate local scores from model judgments. Add explicit query aspects and experimental AST excerpt/constant context options, plus offline grouped calibration and four-arm evaluation tools. Search/context use Jev automatically when a dedicated Jev credential is configured; explicit off and SENSEGREP_JEV_MODE take precedence, and a generic OpenRouter key alone does not enable it.
...
- Updated dependencies [[`ab3cfb5`](https://github.com/Stahldavid/sensegrep/commit/ab3cfb5dfb7295f8e05666e407cb5d4b72aaced0)]:
  - @sensegrep/core@1.19.0
...
- [#39](https://github.com/Stahldavid/sensegrep/pull/39) [`38e01ee`](https://github.com/Stahldavid/sensegrep/commit/38e01ee3a78794f3cf63c0f5658419137cf9613a) Thanks [@Stahldavid](https://github.com/Stahldavid)! - Improve code discovery with a larger candidate pool, complete lexical file coverage, discriminative term scoring, deterministic reconstruction ordering, and parallel hybrid retrieval by default. Select compact relevant context before truncating oversized symbols.

  Classify JavaScript/TypeScript graph calls from AST call sites, resolve named relative import aliases, and invalidate older graph caches. Prefer symbol-based survey/cluster titles over generic imports.

  Detect exact duplicates before neighbor search, compare small eligible sets in memory, filter larger ANN queries before top-k, and persist snapshot-bound continuation checkpoints so resumed scans retain previous pairs.

  Make chunk targets, symbol preservation, maximum input and overlap configurable. Support local Hugging Face tokenizers, validate the full chunk after metadata/overlap, split without dropping input, and include policy/tokenizer identity in index migration. Set an explicit Ollama runtime context, verify installed model capacity, disable silent truncation and bound HTTP batches by tokens.

### Patch Changes

- Updated dependencies [[`38e01ee`](https://github.com/Stahldavid/sensegrep/commit/38e01ee3a78794f3cf63c0f5658419137cf9613a)]:
...
- Updated dependencies [[`66c9b74`](https://github.com/Stahldavid/sensegrep/commit/66c9b7401d2303627d7e9abb082f5c70f4658c88)]:
  - @sensegrep/core@1.12.0
...
- Updated dependencies [[`ab5bf2b`](https://github.com/Stahldavid/sensegrep/commit/ab5bf2b877f802df9cbc50ca8e4e17e20c64049c)]:
  - @sensegrep/core@1.11.0
...
- Updated dependencies [[`734ee52`](https://github.com/Stahldavid/sensegrep/commit/734ee5286dc04f974eec682a2c3ae9978fa89cf6)]:
  - @sensegrep/core@1.10.0
...
- Updated dependencies [[`b155b33`](https://github.com/Stahldavid/sensegrep/commit/b155b33fcdedd80d74ab46d26ea90254a634ca09)]:
  - @sensegrep/core@1.5.2
...
- Updated dependencies [[`1ca19af`](https://github.com/Stahldavid/sensegrep/commit/1ca19af9764a39d080e8f7d49b5d34047742d745)]:
  - @sensegrep/core@1.5.1
...
- Updated dependencies [[`ed8d00a`](https://github.com/Stahldavid/sensegrep/commit/ed8d00a3bdbebbdcdda021ee7119b6202b8e4caf)]:
  - @sensegrep/core@1.5.0
